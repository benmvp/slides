...
[@benmvp](https://twitter.com/benmvp) | [benmvp.com](/) | [#FluentConf](https://twitter.com/hashtag/FluentConf)  
...
<table class="data-table">
	...
	<tbody>
		<tr>
			<th>8:00<br />9:00</th>
			<td colspan="6" align="center">Coffee Break</td>
		</tr>
		<tr>
			<th>9:00<br />9:40</th>
			<td>The thing about frameworks</td>
			<td>RxJS 5: Thinking reactively</td>
			<td>CSS: WTF?</td>
			<td>Deep dive into the React component lifecycle</td>
			<td>Don’t kill them softly</td>
			<td>&nbsp;</td>
		</tr>
		<tr>
			<th>9:50<br />10:30</th>
			<td>Reliably measuring responsiveness in the wild</td>
			<td>Schema-first development with GraphQL</td>
			<td>Yes, your site can (and should) be accessible</td>
			<td>Push notifications for web apps</td>
			<td>Making money in an ecosystem of ad blockers</td>
			<td>Top 10 DevOps questions</td>
		</tr>
		<tr>
		...
		<tr>
			<th>11:00<br />11:40</th>
			<td>Building a style guide</td>
			<td>JavaScript behind the scenes: Metaprogramming</td>
			<td>Flexing your Flexbox Muscles 💪🏾</td>
			<td>Creating a scalable, secure, offline-first, dynamic (static) website</td>
			<td>Third parties: Friend or foe?</td>
			<td>Seamless cross-device experiences</td>
		</tr>
		<tr>
			<th>11:40<br />1:00</th>
...
- They have some weird names and how they work can be a bit confusing
...
<div class="container-example" style="margin-bottom:80px;">
	<div class="item-example item-example-1" style="flex:2 0 15%;background:#008b44">one</div>
	<div class="item-example item-example-2" style="flex:1 0 15%">two two</div>
	<div class="item-example item-example-3" style="flex:1 0 15%">three three three</div>
	<div class="item-example item-example-4" style="flex:1 0 15%">four four four four</div>
</div>

```
.item   { flex-grow: 1; flex-basis: 15%; }
.item-1 { flex-grow: 2; }
```
<!-- .element class="large" -->

<a href="javascript:$('section.stack.present section.present .item-example-1').css('flex', '0 1 15%')">
  <code><em>&nbsp;&nbsp;0&nbsp;&nbsp;</em></code></a> |
<a href="javascript:$('section.stack.present section.present .item-example-1').css('flex', '1 1 15%')">
  <code>&nbsp;&nbsp;1&nbsp;&nbsp;</code></a> |
<a href="javascript:$('section.stack.present section.present .item-example-1').css('flex', '2 1 15%')">
  <strong><code>&nbsp;&nbsp;2&nbsp;&nbsp;</code></strong></a> |
<a href="javascript:$('section.stack.present section.present .item-example-1').css('flex', '5 1 15%')">
  <code>&nbsp;&nbsp;5&nbsp;&nbsp;</code></a>

NOTES:
- `flex-basis` is usually accompanied by `flex-grow`
- `flex-grow` defines the ability for the item to grow if necessary
- If there's extra space after sizing the elements they will be stretched based on remaining space
- Unitless values
- Options:
  - `0` means don't grow is default
  - Positive numbers only
- This sets all items to same grow factor and overrides first item to grow at 2x
- It won't necessarilly be twice the size
...
```
.item   { flex-shrink: 1; flex-basis: 30%; }
...
.media\__body { flex: 1; }</code></pre>
	...
	<div style="flex:0 0 36%;">
		<div style="display:flex;align-items:flex-start;background:whitesmoke;border-radius:5px;padding:.5em">
			<img src="../../img/headshot.jpg" alt="Ben Ilegbodu" style="margin-right:1em;width:200px;border-radius:50%" />
			<div>
...
![Fluent logo](../../img/conf-logos/fluent-logo.svg)
<!-- .element: style="width: 85%;border: 0; background: none; margin: 0; box-shadow: none;" -->
