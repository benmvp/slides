...
[@benmvp](https://twitter.com/benmvp) | [benmvp.com](/) | [@fogcityruby](https://twitter.com/fogcityruby)  
...
- Eventbrite uses Python and previous job was in C#
- Only Ruby code I've seen was in an interview
- Talk about imposter syndrome!
- But luckily I do know...
...
- Blog has details
- Ideal situation is I'd show ES6 functionality compared to Ruby
- But I didn't want to get booed off the stage pretending
- So instead I'll show old (ES5) with new (ES6)
...
- JavaScript is now over 20 years old
...
let [, mo, day, yr] = /^(\d\d)-(\d\d)-(\d\d)$/.exec('04-11-17');
    // mo='04', day='11', yr='17'
```
<!-- .element: class="large" -->
...
<!-- .slide: data-background="url(../../img/giphy/confused-tom-hanks.gif) no-repeat center" data-background-size="contain"-->
...
![Usain Bolt Thumbs Up](../../img/giphy/superstore-mark-mckinney-thumbs-up.gif)
