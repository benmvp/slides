...
- One last thing...
  ...
  - So now your package can look "official" hosted on Netlify or Vercel
...
- But the very next thing I'll need are TypeScript types from your lib
...
<div style="display:flex; justify-content: flex-end">
  <div class="content-overlay" style="width: 40%">
    ...
    <div style="height: 750px; width:350px; margin:0 auto; position:relative; ">
      ...
      <div style="width: 100%; border-bottom: 3px solid black; display: flex; justify-content: space-around; position: absolute; bottom: 72.2%; left: 0">
        <span>72%</span>
        <a href="https://2020.stateofjs.com/en-US/technologies/javascript-flavors/" target="_blank">2020</a>
      </div>
      <div style="width: 100%; border-bottom: 3px dashed black; display: flex; justify-content: space-around; position: absolute; bottom: 87.7%; left: 0">
        <span>88%</span>
        <span>(<a href="https://2019.stateofjs.com/javascript-flavors/" target="_blank">2020</a>)</span>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="content-overlay" style="width: 65%">
    <div style="display:flex;align-items:flex-end;justify-content:space-around;margin-top:5%">
     <div style="flex:0 0 31%;">
      ...
      <div style="flex:0 0 31%;">
        <a href="https://jestjs.io/" target="_blank" style="display: block"><img src="../../img/nav-react/jest-logo-light.svg" class="plain" style="width: 95%"/></a>
        Testing + Coverage
      </div>
  </div>
</div>
